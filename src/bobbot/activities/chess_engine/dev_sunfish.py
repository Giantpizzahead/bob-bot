"""
Source: https://github.com/thomasahle/sunfish/tree/master
Modified to play at a lower elo.
"""
...
class Searcher:
    ...
    def bound(self, pos, gamma, depth, can_null=True):
        ...
        for move, score in moves():
            # Randomize
            score += random.randint(-RAND_SCORE, RAND_SCORE)
            best = max(best, score)
            if best >= gamma:
...
import tools.dev_uci as dev_uci

dev_uci.run(sys.modules[__name__], hist[-1])
sys.exit()
# minifier-hide end
